...
knitr::opts_chunk$set(eval = F, echo = T, warning = F, message = F)
...
Now that the ui is taken care of, the tricky part starts. I define a funtion, `lookup_transcripts_from_symbols`, that uses Stephen Turner's reliable [annotables](https://github.com/stephenturner/annotables) package. 
